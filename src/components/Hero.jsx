...
const Hero = ({ title, subtitle, image, height = "min-h-[70vh]" }) => {
  return (
    <div className={`relative w-full ${height} flex items-center justify-center overflow-hidden`}>
      ...
      {/* Modern Gradient Overlay: Blue Energy to Green Banana */}
      <div className="absolute inset-0 bg-gradient-to-r from-gbc-black/80 via-gbc-black/50 to-gbc-green/30 z-0 backdrop-blur-[1px]" />
